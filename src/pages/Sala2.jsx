...
const Sala2 = () => {
  ...
  switch (idioma) {
    case "ingles":
      dataSala2 = require('../bd/ingles/Sala2.json')
      break;
    case "frances":
      dataSala2 = require('../bd/frances/Sala2.json')
      break;
    case "creole":
      dataSala2 = require('../bd/creole/Sala2.json')
      break;
    case "español":
      dataSala2 = require('../bd/spaniol/Sala2.json')
      break;
    default:
      dataSala2 = require('../bd/spaniol/Sala2.json')
      break;
    ...
    <AnimatePresence>
      <motion.div
        ...
        <section
          ...
          className='pySection'>
          <ModelSlider listaStatus={true} {...dataSala2.section22} />
        </section>
