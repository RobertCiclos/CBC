...
const ModelTitle = (props) => {
  ...
  return (
    <div>
      ...
      <div
        className='w-[311px]  top-0 absolute left-[50%] translate-x-[-50%]
          sm:w-auto sm:translate-x-0 sm:left-0 sm:px-[8%]
          xl:top-0 xl:left-[50%] xl:translate-x-[-50%] xl:w-[1016px] xl:px-0'>
        <motion.h1
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 1 }}
          className=' text-left w-[75px] mt-[1.5rem] text-[20px] 
            sm:w-[100px] md:text-[32px] md:w-[150px] 
            xl:ml-0 xl:text-[56px] xl:w-[210px]'>
          {props.sala}
        ...
        visible &&
          <motion.div
            ...
            <div
              ...
              xl:text-[47px] xl:leading-[64px] xl:py-[24px]'>
              {props.title}
            </div>
          </motion.div>
      }
