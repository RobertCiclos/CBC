...
const DropNavTopBgNone = (props) => {
    ...
    switch (idioma) {
        case "ingles":
            idiomaBtn =
                <a
                    className="dropdown-item bg-none gap-[8px] 
        ...
        <div className="flex">
            <div>
                <div className="dropdown relative">
                    <button
                        className=" dropdown-toggle px-4 py-2.5  bg-none  text-white 
...
export default DropNavTopBgNone